...
export default class Input extends React.Component {
  constructor(props) {
    ...
    if (this.props.value !== 'undefined')
      console.error(this.constructor.name, 'should not be passed value, use default value')
  }
  ...
  componentWillReceiveProps(newProps) {
    ...
    if (defaultValue !== (this.props.defaultValue || '') && defaultValue !== this.state.value) {
      // if the defaultValue has changed since the previous one, and if it is different than the current state
  ...
  winkStyle() {
    return this.state.wink
      ? Object.assign({}, this.props.style, {
          transition: 'background-color 0.5s linear',
          backgroundColor: this.winkColor,
        })
      : Object.assign({}, this.props.style, { transition: 'background-color 0.5s linear' })
  }
...
Object.defineProperty(Input.prototype, 'value', {
  ...
  set: function(v) {
    if (this.state.value !== v) this.setState({ value: v })
  },
})
