...
const participants = {
    moderator: {
        speaking: ['https://res.cloudinary.com/hf6mryjpf/video/upload/v1565641226/undebate-short-m1.mp4', 'https://res.cloudinary.com/hf6mryjpf/video/upload/v1565641208/undebate-short-m2.mp4', 'https://res.cloudinary.com/hf6mryjpf/video/upload/v1565641208/undebate-short-m4.mp4','https://res.cloudinary.com/hf6mryjpf/video/upload/v1565641207/undebate-short-m6.mp4'],
    ...
    audience1: {
        speaking: ['https://res.cloudinary.com/hf6mryjpf/video/upload/v1565641286/undebate-short-w1.mp4', 'https://res.cloudinary.com/hf6mryjpf/video/upload/v1565641286/undebate-short-w2.mp4','https://res.cloudinary.com/hf6mryjpf/video/upload/v1565641286/undebate-short-w3.mp4'],
        listening: 'https://res.cloudinary.com/hf6mryjpf/video/upload/v1565641303/undebate-short-ws.mp4',
    },
    human: {},
    audience2: {
        speaking: ['https://res.cloudinary.com/hf6mryjpf/video/upload/v1565640905/undebate-short-a1.mp4', 'https://res.cloudinary.com/hf6mryjpf/video/upload/v1565640905/undebate-short-a2.mp4','https://res.cloudinary.com/hf6mryjpf/video/upload/v1565640905/undebate-short-a3.mp4'],
...
class RASPAskWebRTC extends React.Component {
    ...
    componentDidMount() {
        ...
        let i;
        for(i=0;i<participants.moderator.speaking.length;i++){ // then load the rest of the speaking parts
            Object.keys(participants).forEach(participant=>{
                if(participant==='moderator'&&i===0) return; // moderator's first speaking part was loaded first
                if(participant==='human') return; 
                if(participants[participant].speaking[i])
    ...
    async getCameraMedia() {
        if(participants.human) // if we have a human in this debate
        {
            const constraints = {
                audio: {
    ...
    nextMediaState(part) {
        ...
        if (speaking) {
            ...
            if (!(objectURL = this.participants[part].listeningObjectURL))
                            ...
                            <div style={{width: "50vw", height: "calc(50vw * 0.5625)"}}>
                                <div style={{ width: '100%', height: '100%', display: 'table' }} >
                                    <div style={{ display: 'table-cell', verticalAlign: 'middle', textAlign: 'center' }} >
                                        ...
                                        <div><button className={classes['beginButton']} onClick={()=>this.setState({begin: true},()=>this.getCameraMedia())}>Begin</button></div>
                                    </div>
                                </div>
                            </div>
                        </div>
